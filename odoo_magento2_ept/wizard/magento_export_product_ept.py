...
class MagentoExportProductEpt(models.TransientModel):
    ...
    def export_product_stock_operation(self, instances):
        ...
        for instance in instances:
            ...
            log = log.create_common_log_book(process_type='export',
                                             ...
                                             module='magento_ept')
            # log = instance.create_common_log_book(process_type='export', module_name='magento_ept')
            self.export_product_stock_magento(instance, product_ids, log)
            if log and not log.log_lines:
                log.unlink()
        return True
    ...
    def export_product_stock_magento(self, instance, product_ids, log):
        ...
        if instance.magento_version in ['2.1', '2.2'] or not instance.is_multi_warehouse_in_magento:
            ...
            # will be called.
            self.export_stock_non_msi(instance, product_ids, log)
        else:
            self.export_stock_with_msi(instance, product_ids, log)
        return True
    ...
    def export_stock_non_msi(self, instance, product_ids, log):
        """
        ...
        if product_stock:
            ...
            if stock_data:
                ...
                return m_product.call_export_product_stock_api(instance, api_url, data, log, 'PUT')
        return True

    def export_stock_with_msi(self, instance, product_ids, log):
        """
        ...
        if stock_data:
            data = {
                'sourceItems': stock_data
            }
            api_url = "/V1/inventory/source-items"
            return m_product.call_export_product_stock_api(instance, api_url, data, log, 'POST')
        return True
